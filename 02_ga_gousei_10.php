...
$name = $_GET["short_name"];
$form_hori_size= $_GET["horizontal_size"];
$form_ver_size = $_GET["vertical_size"];
...
//	$kotei_w = 700;					// アウトプット画像の幅
	$kotei_w = $form_hori_size;					// アウトプット画像の幅
